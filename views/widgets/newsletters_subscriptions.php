	...
	<?php else: ?>
		...
		<form class="newsletter-form" name="newsletter_subscription_<?php echo $unique_id ?>" action="/" onsubmit="return mail_subscriber_newsletters.subscribe_user('<?php echo $unique_id ?>')">
			<p class="input-block newsletter-name">
				<input type="text" name="newsletter_subscription_name" placeholder="<?php _e('enter your name *', 'newsplus') ?>" id="newsletter_subscription_name_<?php echo $unique_id ?>" value="" />
			</p>
			<p class="input-block newsletter-email">
				<input type="text" name="newsletter_subscription_email" placeholder="<?php _e('enter your e-mail *', 'newsplus') ?>" id="newsletter_subscription_email_<?php echo $unique_id ?>" value="" />
